...
#define ZIG_LUAU_COMPILER(name) (Luau_Compiler_##name)
...
EXPORT const char* ZIG_LUAU_COMPILER(compile_ParseResult)(
...
EXPORT void ZIG_LUAU_COMPILER(compile_free)(void* ptr)
{
    free(ptr);
}